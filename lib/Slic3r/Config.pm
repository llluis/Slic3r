...
our $Options = {
    ...
    'perimeter_flow_ratio' => {
        label   => 'Perimeters',
        tooltip => 'This factor affects the amount of plastic for perimeters.',
        cli     => 'perimeter-flow-ratio=f',
        type    => 'f',
        default => 1,
    },
    'solid_infill_flow_ratio' => {
        label   => 'Solid infill',
        tooltip => 'This factor affects the amount of plastic for solid infills.',
        cli     => 'solid-infill-flow-ratio=f',
        type    => 'f',
        default => 1,
    },
    'top_solid_infill_flow_ratio' => {
        label   => 'Top solid infill',
        tooltip => 'This factor affects the amount of plastic for top solid infills.',
        cli     => 'top-solid-infill-flow-ratio=f',
        type    => 'f',
        default => 1,
    },
    'infill_flow_ratio' => {
        label   => 'Infill',
        tooltip => 'This factor affects the amount of plastic for sparse infills.',
        cli     => 'infill-flow-ratio=f',
        type    => 'f',
        default => 1,
    },
    'vibration_limit' => {
...
END
    ...
    'retract_length_speed' => {
        label   => 'Speed @ Length',
        tooltip => 'The speed at the length for retractions will be maximum (it only applies to the extruder motor).',
    ...
    'retract_min_length' => {
        ...
        tooltip => 'When retraction is triggered, filament is pulled back at least by the specified amount (the length is measured on raw filament, before it enters the extruder).',
        sidetext => 'mm (zero to disable)',
    ...
    'unretract_speed' => {
        label   => 'Un-Retract Speed',
        tooltip => 'The speed for unretractions (it only applies to the extruder motor).',
        sidetext => 'mm/s (zero to be same as retract)',
    ...
    'pressure_multiplier' => {
        label   => 'Advance Multiplier',
        tooltip => 'Pressure management multiplier. If greater than zero, it will inject or retract additional filament to control the pressure in bowden systems.',
